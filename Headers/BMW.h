/**
 * @file BMW.h
 * @brief BMW subtype with model/body-style and rain-sensing wiper adjustments.
 */
...
public:
    /**
     * @brief Construct a BMW; washTime depends on model, body style, and options.
     * @param arrivalTime Simulation second when this car arrives.
     */
    BMW(int arrivalTime);

    /** @brief Destroy this BMW. */
    virtual ~BMW();
    ...
    /** @brief Print base and BMW-specific fields to stdout. */
